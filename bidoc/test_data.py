        ...
        'tables': [
            {
                ...
                'columns': [
                    ...
                    {'name': 'CustomerID', 'data_type': 'Int64', 'is_hidden': False, 'description': 'Customer identifier'},
                    {'name': 'ProductID', 'data_type': 'Int64', 'is_hidden': False, 'description': 'Product identifier'},
                    {'name': 'SalesAmount', 'data_type': 'Decimal', 'is_hidden': False, 'description': 'Total sales amount'},
                    {'name': 'OrderDate', 'data_type': 'DateTime', 'is_hidden': False, 'description': 'Date of sale'}
                ],
                'row_count': 50000
            },
            {
                ...
                'columns': [
                    {'name': 'ProductID', 'data_type': 'Int64', 'is_hidden': False, 'description': 'Product identifier'},
                    {'name': 'ProductName', 'data_type': 'Text', 'is_hidden': False, 'description': 'Product name'},
                    {'name': 'Category', 'data_type': 'Text', 'is_hidden': False, 'description': 'Product category'},
                    {'name': 'UnitPrice', 'data_type': 'Decimal', 'is_hidden': False, 'description': 'Unit price'}
                ],
                'row_count': 500
            }
        ],
