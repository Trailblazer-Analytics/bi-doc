...
class DAXFormatter:
    ...
    def __init__(self):
        ...
        self.dax_functions = {
            'sum', 'average', 'count', 'countrows', 'max', 'min', 'calculate',
            'filter', 'related', 'relatedtable', 'sumx', 'averagex', 'countx',
            'if', 'switch', 'and', 'or', 'not', 'true', 'false', 'blank',
            'isblank', 'isnumber', 'istext', 'iserror', 'isodd', 'iseven',
            'year', 'month', 'day', 'date', 'today', 'now', 'weekday',
            'yearfrac', 'datediff', 'dateadd', 'format', 'value', 'len',
            'left', 'right', 'mid', 'trim', 'upper', 'lower', 'substitute',
            'concatenate', 'exact', 'find', 'search', 'replace', 'rept',
            'var', 'return', 'divide', 'roundup', 'rounddown', 'round',
            'ceiling', 'floor', 'abs', 'sign', 'mod', 'quotient', 'power',
            'exp', 'ln', 'log', 'log10', 'sqrt', 'pi', 'rand', 'randbetween',
            'lookupvalue', 'selectedvalue', 'hasonevalue', 'hasonefilter',
            'isfiltered', 'iscrossfiltered', 'allselected', 'all', 'values',
            'distinct', 'earlier', 'earliest', 'rankx', 'topn', 'contains',
            'containsrow', 'addcolumns', 'selectcolumns', 'summarize',
            'groupby', 'currentgroup', 'union', 'intersect', 'except',
            'crossjoin', 'naturalinnerjoin', 'naturalleftouterjoin',
            'generateseriesgenerate', 'datatable', 'row', 'calendar',
            'calendarauto', 'parallelperiod', 'sameperiodlastyear',
            'datesinperiod', 'datesbetween', 'totalmtd', 'totalqtd',
            'totalytd', 'firstdate', 'lastdate', 'startofmonth', 'endofmonth',
            ...
            'previousmonth', 'previousquarter', 'previousyear', 'nextmonth',
            'nextquarter', 'nextyear', 'issubtotal', 'userrelationship',
            'userelationship', 'treatas', 'crossfilter', 'keepfilters',
            'removefilters', 'allexcept', 'ignore', 'error', 'iscurrent',
            'pathcontains', 'path', 'pathitem', 'pathitemreverse', 'pathlength',
            'currency', 'fixed', 'int', 'trunc', 'mround', 'gcd', 'lcm',
            'combin', 'permut', 'fact', 'degrees', 'radians', 'sin', 'cos',
            'tan', 'asin', 'acos', 'atan', 'sinh', 'cosh', 'tanh',
            'maxx', 'minx', 'productx', 'concatenatex', 'geomean', 'geomeanx',
            'median', 'medianx', 'percentile', 'percentilex', 'quartile',
            'stdev', 'stdevx', 'stdevp', 'stdevpx', 'var', 'varx', 'varp', 'varpx',
            'beta', 'chisq', 'confidence', 'expon', 'gamma', 'norm', 'poisson',
            't', 'weibull', 'unichar', 'unicode', 'code', 'char', 'hex2dec',
            'dec2hex', 'bin2dec', 'dec2bin', 'oct2dec', 'dec2oct', 'base',
            'decimal', 'dollarde', 'dollarfr', 'effect', 'nominal', 'rate',
            'nper', 'pmt', 'pv', 'fv', 'npv', 'irr', 'mirr', 'xirr', 'xnpv',
            'accrint', 'accrintm', 'coupdaybs', 'coupdays', 'coupdaysnc',
            'coupncd', 'coupnum', 'couppcd', 'cumipmt', 'cumprinc', 'db',
            'ddb', 'disc', 'duration', 'intrate', 'mduration', 'oddfprice',
            'oddfyield', 'oddlprice', 'oddlyield', 'price', 'pricedisc',
            'pricemat', 'received', 'sln', 'syd', 'tbilleq', 'tbillprice',
            'tbillyield', 'vdb', 'yield', 'yielddisc', 'yieldmat'
        }
    ...
    def _format_keywords(self, expression: str) -> str:
        ...
        for keyword in self.keywords:
            ...
            expression = re.sub(pattern, replace_keyword, expression, flags=re.IGNORECASE)
